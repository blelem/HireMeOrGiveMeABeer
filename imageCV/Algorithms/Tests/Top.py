...
#img1 = cv2.imread('./testImages/fit01.jpg', cv2.CV_LOAD_IMAGE_COLOR)
#img2 = cv2.imread('./testImages/Fit02.jpg', cv2.CV_LOAD_IMAGE_COLOR)

img1 = cv2.imread('./testImages/IMG_5283_2.jpg', cv2.CV_LOAD_IMAGE_COLOR)
img2 = cv2.imread('./testImages/IMG_5283_1.jpg', cv2.CV_LOAD_IMAGE_COLOR)
